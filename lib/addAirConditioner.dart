...
class addAirConditioner extends StatefulWidget {
  @override
  _addAirConditionerState createState() => _addAirConditionerState();
}

class _addAirConditionerState extends State<addAirConditioner> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Add an Air Conditioner"),
        centerTitle: true,
