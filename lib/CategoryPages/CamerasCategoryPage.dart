...
class camerasCategoryPage extends StatefulWidget {
  @override
  _camerasCategoryPageState createState() => _camerasCategoryPageState();
}

class _camerasCategoryPageState extends State<camerasCategoryPage> {
                ...
                Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance
                          ...
                          .where('type', whereIn: ["Cameras","CameraAccessories"])
                          .snapshots(),
