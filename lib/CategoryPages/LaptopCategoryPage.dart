...
class laptopCategorypage extends StatefulWidget {
  @override
  _laptopCategorypageState createState() => _laptopCategorypageState();
}

class _laptopCategorypageState extends State<laptopCategorypage> {
